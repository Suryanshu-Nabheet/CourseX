...
export async function createPaymentIntent(
  ...
  try {
    ...
    const platformFee = Math.round(amount * (paymentConfig.platformFeePercent / 100))
...
export async function confirmPayment(paymentIntentId: string): Promise<PaymentConfirmationResult> {
